...
using static NeversoftMultitool.Core.Formats.Texture.Ps2Scene.ZoneTex.ThawZoneTexHeaderClutSupport;
using static NeversoftMultitool.Core.Formats.Texture.Ps2Scene.ZoneTex.ThawZoneTexHeaderSourceResolver;
...
internal static class ThawZoneTexHeaderDataSupport
{
        ...
        ZoneTexHeaderEntry entry)
    {
        ...
        if (bestCandidate.HasValue
            ...
            && ThawZoneTexHeaderLayoutSupport.ShouldPreferPsmt4BiasedAutoSlotCandidate(entry, dataOffsetBias,
                matchedUpload)
