...
The cross-game corpus walk found **588 files** across every
...
animation packets looking for 8-char ASCII names. Cross-referencing
`PreProcessAnimPacket` (psx_decompiled.c:59115) and inspecting real 0x45 chunks
confirm the on-disk layout now walked by `PsxAnimDumpWalker`:
