...
.PARAMETER Ini
    Path to the PCSX2 INI file to modify. Defaults to PCSX2_INI, then the
    current user's Documents/PCSX2/inis/PCSX2.ini. The script refuses to
    create one from scratch.

.PARAMETER PcsX2Exe
    Path to pcsx2-qt.exe. Defaults to PCSX2_EXE, then pcsx2-qt.exe on PATH.
...
.EXAMPLE
    .\capture_pcsx2_rt_dumps.ps1 `
        -GsDump '<path-to-capture>\capture.gs' `
