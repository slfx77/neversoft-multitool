...
Usage:
  python tools/diagnostics/native_reference_sweep.py [--our-dir TestOutput/sweep_fbp]
  ...
  --snaps-dir   PCSX2 snaps dir with the paired .gs/.png pairs
                (default C:/Users/mmc99/Documents/PCSX2/snaps)
  --json PATH   write machine-readable per-capture + aggregate results

Downstream: tools/diagnostics/native_gate.py consumes the --json output and gates
against tools/diagnostics/native_baseline.json.
"""
import glob
import json
import os
...
DEFAULT_SNAPS_DIR = r"C:\Users\mmc99\Documents\PCSX2\snaps"
...
def main():
    ...
    if good:
        ...
        print(f"\nno pcsx2_native_* capture dirs under {native_root} — "
              f"run tools/diagnostics/capture_all_native.ps1 first")
