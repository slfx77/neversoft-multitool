...
Usage:
    python tools/research/snd-codec/snd_codec_fit.py                 # score every model
    python tools/research/snd-codec/snd_codec_fit.py --model ima     # one model
    python tools/research/snd-codec/snd_codec_fit.py --pairs 50      # fewer pairs, faster
    python tools/research/snd-codec/snd_codec_fit.py --list          # list model names
