...
Usage:
    python tools/research/snd-codec/snd_probe_gen.py -o TestOutput/snd-codec/probes/
    python tools/research/snd-codec/snd_probe_gen.py -o TestOutput/snd-codec/probes/ --seconds 0.5
    python tools/research/snd-codec/snd_probe_gen.py --list
