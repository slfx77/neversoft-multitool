...
Usage:
    ...
    python tools/research/snd-codec/snd_solve.py --pair ramp-max=probe.snd,captured.raw
    python tools/research/snd-codec/snd_solve.py --pair dither=p.snd,c.raw --pair sweep=q.snd,d.raw
