...
Usage:
    python tools/safedisc/iso9660_reader.py <image.bin> --pvd
    python tools/safedisc/iso9660_reader.py <image.bin> --ls
    python tools/safedisc/iso9660_reader.py <image.bin> --extract THUG2.EXE -o out.exe
    python tools/safedisc/iso9660_reader.py <image.bin> --sector 16
"""
